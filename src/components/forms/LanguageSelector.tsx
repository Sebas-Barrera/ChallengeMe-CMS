          ...
          return (
            <button
              ...
              className={`
                ...
                ${isOnlySelected ? 'opacity-75 cursor-not-allowed' : 'cursor-pointer'}
                group
              `}
            >
              {/* Checkmark */}
              {isSelected && (
                <div className="absolute top-1 right-1 w-5 h-5 rounded-full bg-brand-yellow flex items-center justify-center">
                  <svg
